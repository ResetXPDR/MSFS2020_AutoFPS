...
- If FG is being incorrectly reported as enabled by the app, the likely reason is that had been using the FG mod and you removed it without changing the MSFS FG setting to off. To fix, change the DLSSG line in your UserCfg.opt file to be DLSSG 0.
